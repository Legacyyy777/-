...
## 🚀 Быстрый деплой на VPS (3 команды!)
...
# См. инструкцию ниже или в DEPLOY.md
...
📚 **Подробнее:**
- [DEPLOY.md](DEPLOY.md) - быстрая инструкция
- [AUTO_DEPLOY_GUIDE.md](AUTO_DEPLOY_GUIDE.md) - полный гайд
